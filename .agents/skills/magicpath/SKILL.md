---
name: magicpath
description: Search, preview, inspect, and install MagicPath UI components with the magicpath-ai CLI. Use for MagicPath components, designs, themes, teams, projects, and codebase imports.
